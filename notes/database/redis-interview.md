---
title: Redis常见面试题总结
tags: [redis, cache, interview, database, persistence, cluster, optimization]
created: 2026-05-09
...
特性本地缓存Redis数据一致性多服务器部署时存在数据不一致问题数据一致内存限制受限于单台服务器内存独立部署，内存空间更大数据丢失风险服务器宕机数据丢失可持久化，数据不易丢失管理维护分散，管理不便集中管理，提供丰富的管理工具功能丰富性功能有限，通常只提供简单的键值对存储功能丰富，支持多种数据结构和功能
## 常见的缓存读写策略有哪些？
...
类型字节位sdshdr5sdshdr818sdshdr16216sdshdr32432sdshdr64864
